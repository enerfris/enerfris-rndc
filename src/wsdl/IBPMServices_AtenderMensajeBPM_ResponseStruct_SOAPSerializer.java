...
public class IBPMServices_AtenderMensajeBPM_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IBPMServices_AtenderMensajeBPM_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct instance = new wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct();
        wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct instance = (wsdl.IBPMServices_AtenderMensajeBPM_ResponseStruct)obj;
