...
public class UpdateRemolque implements Runnable {
    ...
    public UpdateRemolque(Remolque remolque,DataSourceClass dataSource,Connection conn) {
        this.conn = conn;
    ...
    private String buildQuery() {
        ...
        String query = "update remolque set ";
