...
public class IBPMServices_AtenderMensajeBPM_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IBPMServices_AtenderMensajeBPM_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct instance = new wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct();
        wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_Request_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct instance = (wsdl.IBPMServices_AtenderMensajeBPM_RequestStruct)obj;
