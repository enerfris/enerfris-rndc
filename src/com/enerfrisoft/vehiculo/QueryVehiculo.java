...
public class QueryVehiculo implements Runnable {
    ...
    public QueryVehiculo(Vehiculo vehiculo, DataSourceClass dataSource,Connection conn) {
        this.conn = conn;
    ...
    private String buildQueryWithAtributes() {
        ...
        String query = "replace into vehiculo(";
